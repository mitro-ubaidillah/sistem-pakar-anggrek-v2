    ...
    <div class="container text-center pt-5 pb-5">
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-sm-6 text-start pb-4">
                <p>
                    <img src="{{ asset('img/icon/fb.png') }}" alt="email" class="pe-2">
                    <b class="pe-2">Email</b>
                    <em>anggrek@gmail.com</em>
                </p>
                <p>
                    <img src="{{ asset('img/icon/wa.png') }}" alt="WA" class="pe-2">
                    <b class="pe-2">WA</b>
                    <em>088792356</em>
                </p>
                <p>
                    <img src="{{ asset('img/icon/fb.png') }}" alt="FB" class="pe-2">
            ...
            <div class="col-12 col-md-6 col-sm-6 pb-4">
                ...
                <img src="{{ asset('img/map.png') }}" alt="map" class="w-100">
            </div>
        </div>
    </div>
</div>
