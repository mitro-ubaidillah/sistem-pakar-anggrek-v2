    ...
    <div class="container-fluid ps-5 pe-5">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link font-color-primary ms-3 {{ ($title === "Blog") ? 'active bg-one' : '' }}" href="/blog">Kontak Kami</a>
          </li>
          <li class="nav-item">
            <a class="nav-link font-color-primary ms-3 {{ ($title === "Blog") ? 'active bg-one' : '' }}" href="/blog">Buku Panduan</a>
          </li>
        </ul>
        <span class="navbar-text">
          <a class="btn btn-second" href="/blog">Login</a>
        </span>
      </div>
    </div>
  </nav>